...
export default function Login() {
  ...
  useEffect(() => {
    ...
    if (params.get("reset")    === "1") setReset(true);   // add this
  }, []);
          ...
          <div className="card-body p-4">
            ...
            {unverified && (
              <div className="alert alert-warning py-3 small mb-3">
                ...
                <p className="mb-2">
                  Please verify your email <strong>{email}</strong> before signing in.
                </p>
                {resendMsg && (
                  <p className="mb-2 text-success">{resendMsg}</p>
                )}
                {resendError && (
                  <p className="mb-2 text-danger">{resendError}</p>
                )}
                <button
