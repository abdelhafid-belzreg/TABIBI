...
import {
  User, Mail, Phone, Calendar, FileText, Save,
        ...
        <div className="col-12 col-lg-9 col-xl-8">
          ...
          <div className="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-secondary small mb-0">Manage your personal information</p>
            </div>
          </div>
          ...
          <div className="card border-0 shadow-sm mb-4">
            <div className="card-header bg-body-secondary py-2">
              <strong className="small text-uppercase text-secondary">Edit Personal Information</strong>
            </div>
            <div className="card-body">
              {profileMsg && (
              ...
              <form onSubmit={handleSave}>
                <div className="row g-3">
                  ...
                  <div className="col-12">
                    <label className="form-label small d-flex align-items-center gap-1">
                      <FileText size={13} /> Medical Notes
                    </label>
                    <textarea
                      className="form-control"
                      value={medicalNotes}
                      onChange={(e) => setMedicalNotes(e.target.value)}
                      placeholder="Any allergies, conditions, medications, etc."
                      rows={4}
                    />
                    <div className="form-text">This information helps doctors provide better care.</div>
                  </div>
                  ...
                  <div className="col-12">
                    <ul className="list-unstyled small mb-0 d-flex flex-wrap gap-2">
                      {[
                        ...
                        { rule: /[A-Z]/.test(newPassword),         text: "Uppercase"       },
          ...
          <div className="card border-danger shadow-sm">
            ...
            <div className="card-body">
              <p className="text-secondary small mb-3">
                Once you delete your account, all your data including appointments and medical notes
